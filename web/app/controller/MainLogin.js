Ext.define('PiClim.controller.MainLogin', {
    ...
    _userLoginSuccess: function(fullname, temperatures)
    {
        ...
        this.getTemperaturesChart().getStore().on('beforeload', function(store, operation) {
            operation.params.fromDate = this.getTemperaturesChartTimeAxis().getFromDate().getTime()/1000;
            operation.params.toDate = this.getTemperaturesChartTimeAxis().getToDate().getTime()/1000;
        }, this);
